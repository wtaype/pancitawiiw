// src/features/panel/musica/musica.js
// Motor Principal de Reproducción de Audio Real (100% libre de inline styles)

import { obtenerListaPredeterminada } from './lista/lista.js';
import './musica.css';
  ...
  return `
    <div class="musica_panel_card">
      ...
      <div class="msc_folder_bar">
        <input type="text" class="msc_folder_input" value="src\\features\\panel\\musica\\lista" readonly />
        ...
        <button class="msc_btn_icon_only" id="msc_btn_add" title="Agregar Pistas"><i class="fa-solid fa-plus"></i></button>
      </div>
    </div>
  `;
}
