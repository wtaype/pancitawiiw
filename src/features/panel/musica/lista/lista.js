// src/features/panel/musica/lista/lista.js
...
export const PLAYLIST_REALES = [
  ...
  },
  {
    ...
    archivo: 'Bazovyy Minimum (Базовый Минимум)𝘽𝙚𝙨𝙩 𝙥𝙖𝙧𝙩 -SABI, MIABOYKA ｜ 𝑺𝑳𝑶𝑾𝑬𝑫 + 𝑹𝑬𝑽𝑬𝑹𝑩      audio edit.mp3',
    peso: '7.9 MB',
    url: new URL('./Bazovyy Minimum (Базовый Минимум)𝘽𝙚𝙨𝙩 𝙥𝙖𝙧𝙩 -SABI, MIABOYKA ｜ 𝑺𝑳𝑶𝑾𝑬𝑫 + 𝑹𝑬𝑽𝑬𝑹𝑩      audio edit.mp3', import.meta.url).href
  },
  {
    id: 3,
