...
// Componente de Reloj Hero Masivo de Asistente (Estilo inicio/ con rotación de mensajes y fecha)
...
export function initRelojTimer(container) {
  ...
  function actualizarReloj() {
    ...
    // Progreso diario
    const segundosPasados = (ahora.getHours() * 3600) + (ahora.getMinutes() * 60) + ahora.getSeconds();
  ...
  const rolesTimerId = setInterval(rotarMensajes, 6000);
